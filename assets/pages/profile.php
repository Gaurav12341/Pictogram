                ...
                <div class="d-flex flex-column">
                    ...
                    <?php
                        if($user['id']!=$profile['id']){
                            ...
                            ?>
                            <button class="d-none btn btn-sm btn-primary followbtn" data-user-id='<?=$profile['id']?>'>SelfFollow</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body d-flex p-0">
                        ...
                        <?php
                            ...
                            <div class="d-flex align-items-center p-2">
                                ...
                                <div class="d-flex flex-column justify-content-start align-items-start">
                                    ...
                                    <p style="margin:0px;" class="text-muted"><?=$comment[3]?></p>
                                </div>
                            </div>
                                <?php
                            }
                 ...
                 if(count($profile_post)<1){
                    echo"<p class= 'p-2 bg-white border rounded text-center my-3'>User doesn't have any post !</p>";
                }
            ?>
